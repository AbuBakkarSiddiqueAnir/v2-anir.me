...
for (var ue = 0; ue < nt.length; ue++) on[nt.charCodeAt(ue)] = ue;
...
var Qn = function (e) {
  ...
  pn = function (e, A) {
    var t = Qn(e),
      r = Array.isArray(t) ? cn(t) : new Uint32Array(t),
...
var yn =
  ...
  Vn = function (e, A, t, r, B) {
    ...
    if (
      ...
      (lt.indexOf(a) !== -1 && [wt, Ae].indexOf(Q) !== -1) ||
      (lt.indexOf(Q) !== -1 && a === ee) ||
      ...
      return I;
    if (a === gr && Q === gr) {
      for (var f = t[n], w = 1; f > 0 && (f--, A[f] === gr); ) w++;
      if (w % 2 !== 0) return I;
    }
  ...
  MA = function (e) {
    return P(e) || (e >= CB && e <= uB) || (e >= cB && e <= Us);
  },
  ps = function (e) {
    return e >= cB && e <= hs;
  },
  ...
  Ks = function (e) {
    return (e >= cs && e <= ws) || e === Cs || (e >= ls && e <= us) || e === fs;
  },
  UA = function (e, A) {
    return e !== ne ? !1 : A !== Xe;
  },
  ...
  X = { type: 17, number: 0, flags: we },
  $r = { type: 16, number: 50, flags: we },
  hA = { type: 16, number: 100, flags: we },
  re = function (e, A, t) {
    var r = e[0],
      B = e[1];
  ...
  It = function (e, A) {
    ...
    for (var o = null, s = 0; s < B.length; s++) {
      ...
      if (Q === null) o === null && (o = s);
        ...
        for (
          var g = s - o, c = B[o - 1], f = (Q - c) / (g + 1), w = 1;
          w <= g;
          w++
        )
          B[o + w - 1] = f * w;
  ...
  Ki = (function () {
    function e(A, t) {
      ...
      (this.animationDuration = U(A, Ei, t.animationDuration)),
        ...
        (this.backgroundRepeat = U(A, ca, t.backgroundRepeat)),
        (this.backgroundSize = U(A, Ca, t.backgroundSize)),
        (this.borderTopColor = U(A, ua, t.borderTopColor)),
        ...
        (this.fontWeight = U(A, ui, t.fontWeight)),
        ...
        (this.marginBottom = U(A, Pa, t.marginBottom)),
        (this.marginLeft = U(A, Ja, t.marginLeft)),
...
var qi = 1,
      ...
      Xt(s)
        .then(function (i) {
          ...
          return (
            ...
            (o.style.height = t + "px"),
            Nt(a) ? Xt(Jr(t, t, 0, 0, o)) : Promise.reject(!1)
          );
        })
        .then(function (i) {
              ...
              o.forEach(function (c) {
                n.push(
                  new ie(
                    ...
                    wA.fromDOMRectList(
                      e,
                      _t(r, Q + s, c.length).getClientRects(),
                    ),
                  ),
                ),
                  (Q += c.length);
              });
            } else n.push(new ie(i, wA.fromDOMRectList(e, a)));
          } else {
            var g = r.splitText(i.length);
            n.push(new ie(i, co(e, r))), (r = g);
          }
  ...
  Co = function (e, A) {
    return A.letterSpacing !== 0 ? rt(e) : wo(e, A);
  },
  lo = [32, 160, 4961, 65792, 65793, 4153, 4241],
  uo = function (e, A) {
    for (
      var t = _n(e, {
  ...
  po = function (e) {
    return e.width > e.height
      ? new wA(e.left + (e.width - e.height) / 2, e.top, e.height, e.height)
      : e.width < e.height
        ? new wA(e.left, e.top + (e.height - e.width) / 2, e.width, e.width)
        : e;
  },
  Io = function (e) {
  ...
  ce = function (e, A, t) {
    ...
    switch (A) {
      ...
      case 17:
      case 48:
        return gA(e, "零一二三四五六七八九", qt, "負", B, uA | fA | Be);
      case 47:
        return gA(e, "零壹貳參肆伍陸柒捌玖", jt, "負", B, NA | uA | fA | Be);
      case 42:
        return gA(e, "零一二三四五六七八九", qt, "负", B, uA | fA | Be);
      case 41:
        return gA(e, "零壹贰叁肆伍陆柒捌玖", jt, "负", B, NA | uA | fA | Be);
      case 26:
        return gA(e, "〇一二三四五六七八九", "十百千万", zt, B, 0);
      case 25:
        return gA(e, "零壱弐参四伍六七八九", "拾百千万", zt, B, NA | uA | fA);
      case 31:
        return gA(e, "영일이삼사오육칠팔구", "십백천만", pr, n, NA | uA | fA);
      case 33:
        return gA(e, "零一二三四五六七八九", "十百千萬", pr, n, 0);
      case 32:
        return gA(e, "零壹貳參四五六七八九", "拾百千", pr, n, NA | uA | fA);
      case 18:
    ...
    return (
      (e.prototype.toIFrame = function (A, t) {
            ...
            return J(r, void 0, void 0, function () {
              ...
              return _(this, function (c) {
                switch (c.label) {
                  case 0:
                    return (
                      this.scrolledElements.forEach(Jo),
                      i &&
        ...
        return (
          ...
          Po(this.referenceElement.ownerDocument, n, s),
      ...
      (e.prototype.createElementClone = function (A) {
        ...
        if (Jt(A)) return this.createVideoClone(A);
      ...
      (e.prototype.cloneNode = function (A, t) {
        ...
        if (r && _A(A) && (Yr(A) || Ne(A))) {
          ...
          Yt(A) && (t = !0),
            Jt(A) || this.cloneChildNodes(A, B, t),
              ...
              a.content.forEach(function (g) {
                if (g.type === 0) o.appendChild(i.createTextNode(g.value));
                  ...
                  if (g.name === "attr") {
                    ...
                    var K = g.values.filter(JA),
                      C = K[0],
                      p = K[1],
                      H = K[2];
                    if (C && D(C)) {
                      var d = n.counters.getCounterValues(C.value),
                        u = H && D(H) ? _r.parse(n.context, H.value) : 3,
  ...
  tQ = (function () {
    function e(A) {
      ...
      (this.topLeftBorderDoubleOuterBox =
        n > 0 || s > 0
          ? x(r.left + E / 3, r.top + u / 3, n - E / 3, s - u / 3, m.TOP_LEFT)
          : new l(r.left + E / 3, r.top + u / 3)),
        (this.topRightBorderDoubleOuterBox =
          n > 0 || s > 0
            ? x(r.left + F, r.top + u / 3, a - v / 3, o - u / 3, m.TOP_RIGHT)
            : new l(r.left + r.width - v / 3, r.top + u / 3)),
        (this.bottomRightBorderDoubleOuterBox =
          g > 0 || c > 0
            ? x(r.left + p, r.top + K, g - v / 3, c - y / 3, m.BOTTOM_RIGHT)
            : new l(r.left + r.width - v / 3, r.top + r.height - y / 3)),
        (this.bottomLeftBorderDoubleOuterBox =
          w > 0 || C > 0
            ? x(r.left + E / 3, r.top + d, w - E / 3, C - y / 3, m.BOTTOM_LEFT)
        ...
        (this.topLeftBorderDoubleInnerBox =
          n > 0 || s > 0
            ...
            : new l(r.left + (E * 2) / 3, r.top + (u * 2) / 3)),
        (this.topRightBorderDoubleInnerBox =
          n > 0 || s > 0
            ...
            : new l(r.left + r.width - (v * 2) / 3, r.top + (u * 2) / 3)),
        ...
        (this.topLeftBorderStroke =
          n > 0 || s > 0
            ? x(r.left + E / 2, r.top + u / 2, n - E / 2, s - u / 2, m.TOP_LEFT)
            : new l(r.left + E / 2, r.top + u / 2)),
        (this.topRightBorderStroke =
          n > 0 || s > 0
            ? x(r.left + F, r.top + u / 2, a - v / 2, o - u / 2, m.TOP_RIGHT)
            : new l(r.left + r.width - v / 2, r.top + u / 2)),
        (this.bottomRightBorderStroke =
          g > 0 || c > 0
            ? x(r.left + p, r.top + K, g - v / 2, c - y / 2, m.BOTTOM_RIGHT)
            : new l(r.left + r.width - v / 2, r.top + r.height - y / 2)),
        (this.bottomLeftBorderStroke =
          w > 0 || C > 0
            ? x(r.left + E / 2, r.top + d, w - E / 2, C - y / 2, m.BOTTOM_LEFT)
        ...
        (this.bottomRightBorderBox =
          g > 0 || c > 0
            ? x(r.left + p, r.top + K, g, c, m.BOTTOM_RIGHT)
            : new l(r.left + r.width, r.top + r.height)),
        (this.bottomLeftBorderBox =
          w > 0 || C > 0
            ? x(r.left, r.top + d, w, C, m.BOTTOM_LEFT)
        ...
        (this.topRightPaddingBox =
          a > 0 || o > 0
            ...
            : new l(r.left + r.width - v, r.top + u)),
        ...
        (this.topRightContentBox =
          a > 0 || o > 0
            ...
            : new l(r.left + r.width - (v + k), r.top + u + O)),
        (this.bottomRightContentBox =
          g > 0 || c > 0
            ? x(
                r.left + Math.min(p, r.width - (E + L)),
                r.top + Math.min(K, r.height + u + O),
                Math.max(0, g - (v + k)),
                c - (y + q),
                m.BOTTOM_RIGHT,
              )
...
var x = function (e, A, t, r, B) {
        ...
        if (
          ...
          if (g < 0) {
            ...
            o.negativeZIndex.some(function (w, C) {
              return g > w.element.container.styles.zIndex.order
                ? ((c = C), !1)
                : c > 0;
            }),
  ...
  Kr = function (e, A, t) {
    var r = CQ(XA(e.styles.backgroundOrigin, A), e),
      B = lQ(XA(e.styles.backgroundClip, A), e),
      n = uQ(XA(e.styles.backgroundSize, A), t, r),
      s = n[0],
      i = n[1],
  ...
  uQ = function (e, A, t) {
    ...
    if (VA(s) && (!i || VA(i))) {
      if (Q && g) return [r, B];
      if (!a && !c) return [t.width, t.height];
      if (c && a) {
        var f = Q ? r : B * n,
          w = g ? B : r / n;
        return [f, w];
  ...
  dQ = (function (e) {
    ...
    return (
            ...
            return (
              ...
              t.textBounds.forEach(function (w) {
                g.forEach(function (C) {
                  switch (C) {
                    case 0:
                      (c.ctx.fillStyle = R(r.color)),
                        c.renderTextWithLetterSpacing(w, r.letterSpacing, o);
                      var H = r.textShadow;
                      H.length &&
                        w.text.trim().length &&
                        (H.slice(0)
                    ...
                    case 1:
                      r.webkitTextStrokeWidth &&
                        w.text.trim().length &&
                        ((c.ctx.strokeStyle = R(r.webkitTextStrokeColor)),
        ...
        return J(this, void 0, void 0, function () {
          ...
          return _(this, function (u) {
            switch (u.label) {
              ...
              case 6:
                return (
                  (F = u.sent()), this.renderReplacedElement(r, B, F), [3, 8]
                );
              case 7:
                return (
                  u.sent(),
              ...
              case 10:
                return (
                  (F = u.sent()), this.renderReplacedElement(r, B, F), [3, 12]
                );
              case 11:
                return (
                  u.sent(),
              ...
              case 14:
                if (
                  ...
                  switch (
                    ((c = this.createFontStyle(n)),
                    (p = c[0]),
                    (f = c[1]),
                    (w = this.fontMetrics.getMetrics(p, f).baseline),
                    (this.ctx.font = p),
                ...
                if (((h = r.styles.listStyleImage), h.type !== 0))
                  return [3, 18];
                (F = void 0), (K = h.url), (u.label = 15);
              case 15:
                return (
                  u.trys.push([15, 17, , 18]), [4, this.context.cache.match(K)]
                );
              case 16:
                return (
                  (F = u.sent()),
      ...
      (A.prototype.renderStackContent = function (t) {
        return J(this, void 0, void 0, function () {
          var r, B, h, n, s, h, i, a, h, o, Q, h, g, c, h, f, w, h, C, H, h;
          return _(this, function (F) {
            switch (F.label) {
              case 0:
                        ...
                        case 3:
                          return (
                            ...
                            n.context.logger.error(
                              "Error loading background-image " + c,
                            ),
                            [3, 4]
                          );
                        case 4:
                        ...
                        case 5:
                          sa(Q)
                            ? ((w = Kr(t, r, [null, null, null])),
                              ...
                              (d.height = V),
                              (u = d.getContext("2d")),
                              (v = u.createLinearGradient(h, K, F, p)),
                ...
                c.sent(),
                  ...
                  r.boxShadow
                    ...
                    .forEach(function (f) {
                      ...
                      f.inset
                        ? (g.path(w), g.ctx.clip(), g.mask(H))
                        : (g.mask(w), g.ctx.clip(), g.path(H)),
      ...
      (A.prototype.renderDashedDottedBorder = function (t, r, B, n, s) {
        return J(this, void 0, void 0, function () {
          var i, a, o, Q, g, c, f, w, C, H, h, F, K, p, d, u, d, u;
          return _(this, function (v) {
            return (
              ...
              f <= w * 2
                ...
                : f <= w * 2 + C
                  ? ((h = f / (2 * w + C)), (w *= h), (C *= h))
                  : ((F = Math.floor((f + C) / (w + C))),
                    (K = (f - F * w) / (F - 1)),
                    (p = (f - (F + 1) * w) / F),
                    (C = p <= 0 || Math.abs(C - K) < Math.abs(C - p) ? K : p)),
              H &&
                (s === 3
                  ? this.ctx.setLineDash([0, w + C])
                  : this.ctx.setLineDash([w, C])),
              s === 3
              ...
              s === 2 &&
                ($(a[0]) &&
                  ...
                  this.ctx.beginPath(),
                  this.formatPath([
                    new l(d.end.x, d.end.y),
                    new l(u.start.x, u.start.y),
                  ]),
                  this.ctx.stroke()),
                $(a[1]) &&
                  ((d = a[1]),
  ...
  EQ = function (e) {
    return e instanceof _B || e instanceof XB
      ? !0
      : e instanceof tt && e.type !== ke && e.type !== Je;
  },
  HQ = function (e, A) {
    switch (e) {
      case 0:
    ...
    return (
      ...
      (e.prototype.info = function () {
        ...
        this.enabled &&
          ...
          console.info.apply(console, le([this.id, this.getTime() + "ms"], A));
      }),
        ...
        switch (oA.label) {
          case 0:
            ...
            return (
              ...
              (i = new wA(s.scrollX, s.scrollY, s.windowWidth, s.windowHeight)),
              (a = new LQ(n, i)),
              (o =
          ...
          case 1:
            return (
              (f = oA.sent()),
              (w = Bt(c) || xo(c) ? an(c.ownerDocument) : ze(a, c)),
              (C = w.width),
              (H = w.height),
              (h = w.left),
              (F = w.top),
              (K = xQ(a, c, A.backgroundColor)),
              (p = {
                canvas: A.canvas,
                backgroundColor: K,
                scale:
          ...
          case 3:
            return (
              ...
              (u = kB(a, c)),
              K === u.styles.backgroundColor &&
                (u.styles.backgroundColor = cA.TRANSPARENT),
              a.logger.debug(
...
const TQ = (e) => {
  ...
  SQ = () => {
    let e = document.createElement("div"),
      A = document.getElementById("blogPostContent").cloneNode(!0);
...
document.getElementById("copyButton").addEventListener("click", SQ);
document
  .getElementById("takeScreenshotButton")
  .addEventListener("click", () =>
    TQ(document.getElementById("blogPostContent")),
  );

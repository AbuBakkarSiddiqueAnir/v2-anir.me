 ...
 */ var rt = {
  ...
  _t = function (t, e, i, r) {
    return (
      e.parent && St(e),
      (e._start = Y(
        (yt(i) ? i : i || t !== E ? st(t, i, e) : t._time) + e._delay,
      )),
      (e._end = Y(
  ...
  et = (function () {
    ...
    return (
      (l = {
        ...
        wake: function () {
          Ni &&
            (!Ve &&
              ...
              (ii = at.document || {}),
              (nt.gsap = J),
              (at.gsapVersions || (at.gsapVersions = [])).push(J.version),
              Vi(xe || at.GreenSockGlobals || (!at.gsap && at) || {}),
              (h = at.requestAnimationFrame),
              nr.forEach(sr)),
            o && l.sleep(),
            (u =
              h ||
        ...
        sleep: function () {
          (h ? at.cancelAnimationFrame : clearTimeout)(o), (fe = 0), (u = oe);
        },
...
var K = (function (f) {
  ...
  return (
    ...
    (e.getTweensOf = function (r, n) {
      for (var s = [], a = ut(r), o = this._first, u = yt(n), h; o; )
        o instanceof N
          ? Nr(o._targets, a) &&
            (u
              ? (!vt || (o._initted && o._ts)) &&
    ...
    (e.tweenFromTo = function (r, n, s) {
      return this.tweenTo(n, ft({ startAt: { time: st(this, r) } }, s));
    }),
    (e.recent = function () {
      return this._recent;
    }),
    ...
    (t.updateRoot = function (r) {
      if ((E._ts && (qi(E, be(r, E)), (Yi = et.frame)), et.frame >= gi)) {
        gi += rt.autoSleep || 120;
        var n = E._first;
...
ft(K.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
    ...
    if (
      ...
      for (
        ...
        if (
          ...
          (V = x === m ? w : x.indexOf(b)),
          D &&
            (A = new D()).init(b, B || g, t, V, x) !== !1 &&
            ((t._pt = S =
              new Z(t._pt, b, A.name, 0, 1, A.render, A, 0, A.priority)),
        ...
        t._op && t._op[w] && t.kill(b, t._op[w]),
          v &&
            t._pt &&
            ((vt = t),
            E.killTweensOf(b, q, t.globalTime(e)),
            (U = !t.parent),
            (vt = 0)),
          t._pt && o && (Ue[R.id] = 1);
      }
...
var N = (function (f) {
  ...
  function t(i, r, n, s) {
    ...
    var o = a.vars,
      ...
      y = o.yoyoEase,
      x = r.parent || E,
      v = ($(i) || Fi(i) ? yt(i[0]) : "length" in r) ? [i] : ut(i),
      T,
      g,
      w,
      P,
          ...
          for (S in w)
            for (
              ...
              (q = A[g]),
                (V = {
                  ease: q.e,
                  duration: ((q.t - (g ? A[g - 1].t : 0)) / 100) * u,
                }),
                (V[S] = q.v),
                T.to(v, V, D),
                (D += V.duration);
    ...
    return (
      d === !0 && !Je && ((vt = mt(a)), E.killTweensOf(v), (vt = 0)),
      _t(x, mt(a), n),
  ...
  return (
    (e.render = function (r, n, s) {
      ...
      if (!u) Gr(this, r, n, s);
        ...
        (v &&
          v.render(
            r < 0 ? r : !c && y ? -M : v._dur * v._ease(c / this._dur),
            n,
            s,
          )) ||
...
N.version = K.version = J.version = "3.12.4";
Ni = 1;
ei() && Ht();
O.Power0;
O.Power1;
 ...
 */ var Pi,
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (n === "all" || n === !0) (r.cssText = ""), (o = 1);
        ...
        for (n = n.split(","), u = n.length; --u > -1; )
          (a = n[u]),
            xt[a] && ((o = 1), (a = a === "transformOrigin" ? j : z)),
            Nt(i, a);
      o &&
        (Nt(i, z),
        s &&
  ...
  Wn = function (t, e, i) {
    ...
    r.svg
      ...
      : ((u = getComputedStyle(i)[z]), (s[z] = e), (a = le(i, 1)), (s[z] = u));
    for (o in xt)
      (u = r[o]),
        (h = a[o]),
        u !== h &&
          ...
          if (
            ...
            if (
              ...
              T ||
                ...
                (T = this._pt =
                  new Z(this._pt, a, z, 0, 1, g.renderTransform, g, 0, -1)),
                (T.dep = 1)),
              _ === "scale")
            )
              (this._pt = new Z(
